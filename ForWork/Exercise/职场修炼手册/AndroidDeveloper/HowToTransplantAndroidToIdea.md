As we know ,if we want to Transplant an android project to a new IDE,We must deal with the difference between them. if there are some problems ,we must know why this is a problem,what does that mean.   
